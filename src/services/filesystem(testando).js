...
export function filesystem({
  ...
  function createFile(name, content = '', folderId = 'root') {
    return new Promise((resolve, reject) => {
      let newFile = {
        id: name,
        type: 'file',
  ...
  function deleteObject(targetName, parentId = 'root') {
    return new Promise((resolve, reject) => {
  ...
  function moveObject(targetName, rootId, currentParentId, path) {
    return new Promise((resolve, reject) => {
      let targetFolder
      let currentParent
      let targetObject
  ...
  function concatObjects(folderId) {
    return new Promise((resolve, reject) => {
      let folder
      fetchObject(folderId)
        .then((fetchedFolder) => {
  ...
  function findContent(searchString, folderId) {
    return new Promise((resolve, reject) => {
      let folder
      fetchObject(folderId)
        .then((fetchedFolder) => {
